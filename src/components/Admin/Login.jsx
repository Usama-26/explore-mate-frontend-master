      ...
      <div class="flex flex-wrap w-full">
        <div class="flex flex-col w-full md:w-1/2">
          <div class="flex flex-col justify-center px-8 pt-8 my-auto md:justify-start md:pt-0 md:px-24 lg:px-32">
            <p class="text-3xl text-center">Welcome Admin.</p>
            <form class="flex flex-col pt-3 md:pt-8" action="admin/Dashboard">
              ...
              <button
                type="submit"
                class="w-full px-4 py-2 text-base font-semibold text-center text-white transition duration-200 ease-in bg-orange-500 shadow-md hover:text-black hover:bg-white focus:outline-none focus:ring-2"
              >
        ...
        <div class="w-1/2 shadow-2xl">
          <img
            class="hidden object-cover w-[98%] h-screen md:block"
